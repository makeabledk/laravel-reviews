...
class ScoreTest extends TestCase
{
    ...
    /** @test **/
    function it_calculates_the_score_based_on_rating_values_and_weights()
    {
    ...
    /** @test **/
    function weights_are_simply_relative_to_each_other()
    {
        $this->review()->ratings()->saveMany([
    ...
    /** @test **/
    function score_will_return_as_a_decimal()
    {
        $this->review()->ratings()->saveMany([
    ...
    /** @test **/
    function it_rounds_to_specified_decimals_in_config()
    {
